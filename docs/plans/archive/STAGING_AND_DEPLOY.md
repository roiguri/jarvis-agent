...
**First beneficiary:** the app channel (`docs/plans/archive/app-plans/EXECUTION_PLAN.md`, itself
archived 2026-07-31), but this is general infrastructure and stands on its own.
